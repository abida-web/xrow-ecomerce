  ...
  return (
    <div className="grid grid-cols-1 gap-8 md:gap-5 md:grid-cols-2 items-center min-h-[80vh] px-4 py-8">
      <div className="flex flex-col order-2 md:order-1">
        <p className="flex items-center gap-2 mb-3 bg-orange-500/20 border text-sm border-orange-500/50 text-orange-500 w-fit py-1 px-5 rounded-full ">
          <Rocket size={17} />
          Shop Smart.Live Better.
        </p>
        <h1 className="lg:text-6xl md:text-5xl sm:text-4xl text-3xl text-black font-sans font-bold leading-tight">
          Find Your Needs From Local Stores
        </h1>
        <p className="md:text-lg text-md pt-4 text-gray-500 max-w-lg">
        ...
        <div className="flex items-center gap-4 mt-6 flex-wrap">
          ...
          <Link href="/register">
            <button className=" flex gap-2 items-center border border-orange-500/80 text-orange-500 rounded-lg py-2.5 px-6 transition-all hover:scale-105 hover:bg-orange-500/10 duration-300 cursor-pointer font-medium">
