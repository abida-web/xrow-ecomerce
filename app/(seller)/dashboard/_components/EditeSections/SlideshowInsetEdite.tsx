...
const SlideshowInsetEdite = (props: any) => {
  const {
    selectedSection,
    settings,
    content,
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="border-b border-gray-200 pb-4">
        ...
        <TextField
          ...
          value={settings.buttonPadding || "8px 24px"}
        ...
        <TextField
          label="Shadow"
          value={settings.shadow || "0 25px 50px -12px rgb(0 0 0 / 0.25)"}
...
export default SlideshowInsetEdite;
